const local: App.I18n.Schema = {
  ...
  route: {
    ...
    company: '公司管理',
    inventory: '进销存',
    inventory_dashboard: '业务总览',
    inventory_sheet: '单据表格'
  },
  page: {
    login: {
      common: {
      ...
      register: {
        ...
        fullNamePlaceholder: '请输入管理员姓名',
        fullNameRequired: '请输入管理员姓名',
        createCompany: '创建公司',
        successTitle: '公司创建成功',
        successDesc: '公司 {companyName} 创建成功，系统分配的公司 ID 为 {companyId}。',
        protocol: '《用户协议》',
        policy: '《隐私权政策》'
      },
      resetPwd: {
